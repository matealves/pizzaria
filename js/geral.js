...
pizzaJson.map((item, index) => {
  ...
  let pizzaItem = document.querySelector(".models .pizza-item").cloneNode(true); //cloneNode() = Clona o elemento selecionado com a qtd do JSON
  ...
  pizzaItem.querySelector("a").addEventListener("click", (e) => {
    ...
    document.querySelector(".pizzaInfo--actualPrice").innerHTML = `${pizzaJson[
      key
    ...
    document.querySelectorAll(".pizzaInfo--size").forEach((size, sizeIndex) => {
      ...
      size.addEventListener("click", () => {
        ...
        ).innerHTML = ` ${pizzaJson[key].price[sizeIndex].toLocaleString(
          "pt-br",
...
document.querySelector(".pizzaInfo--qtmenos").addEventListener("click", () => {
  if (modalQt > 1) {
    ...
    let preco = pizzaJson[modalKey].price[size];
    modalQt--;
    document.querySelector(".pizzaInfo--qt").innerHTML = modalQt;
